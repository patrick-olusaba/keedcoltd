...
const STEPS = [
  {
    ...
    title: 'Book a Call',
    body: 'Tell us about your business and current IT setup in a free 30-minute discovery call.',
  },
  {
    ...
    title: 'Get Your IT Audit',
    body: 'We assess your infrastructure, identify risks, and deliver a clear action plan — at no cost.',
  },
  {
    ...
    title: 'We Go Live',
    body: 'Our team onboards within days, not weeks. Zero downtime, seamless handover.',
  },
  {
    ...
    body: '24/7 monitoring, proactive maintenance, and a dedicated engineer who knows your business.',
  },
];
  ...
  return (
    <section className="process">
      <div className="container">
        <Reveal><p className="process__eyebrow">Simple onboarding</p></Reveal>
        <Reveal delay={60}><h2 className="process__heading">How it works</h2></Reveal>
